...
<head>
    ...
    <title>Update Category | ${course_found.name}</title>
</head>
<body>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">${course_found.name}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="course_found" action="${rootAdmin}category/update" method="post">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="name" class="form-control" value="${course_found.name}" id="inputEnterYourName" placeholder="Enter Cate's Name"></f:input>
