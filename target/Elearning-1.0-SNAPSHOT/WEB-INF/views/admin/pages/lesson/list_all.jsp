            ...
            <div class="page-content">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                                <a class="dropdown-item" href="${rootAdmin}lesson/init-insert">Add new</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-9 col-xl-10">
                                        <form class="float-lg-end" method="post" action="${rootAdmin}lesson/search">
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <h6 class="mb-0 text-uppercase">All Lesson</h6>
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lesson}" var="item" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>${item.times}</td>
                                                <td>
                                                    <a href="${rootAdmin}lesson/init-update?id=${item.id}"><i class="bx bxs-edit"></i></a>
                                                    <a href="${rootAdmin}lesson/delete?id=${item.id}"><i class="bx bx-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                            ...
                            <nav aria-label="Page navigation example" class="align-self-center">
                                <ul class="pagination round-pagination">
                                    <li class="page-item" >
                                        <a class="page-link" href="${rootAdmin}lesson/page/${page-1}">Previous</a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="page">
                                        <li class="page-item"><a class="page-link" href="${rootAdmin}lesson/page/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item"><a class="page-link" href="${rootAdmin}lesson/page/${page+1}">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
