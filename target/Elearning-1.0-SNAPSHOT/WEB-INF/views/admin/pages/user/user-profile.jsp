...
<c:url value="/admin/" var="rootAdmin"></c:url>
<html>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="<c:url value="/public/assetAdmin/images/avatars/avatar-2.png"/>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
                                            <h4>${admin_found.name}</h4>
                                            <p class="text-secondary mb-1">Full Stack Developer</p>
                                            <p class="text-muted font-size-sm">${admin_found.address}</p>
                                        </div>
                                    </div>
                                    <hr class="my-4" />
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="${rootAdmin}profile/update-acc">
                                        <input type="hidden" name="id" value="${admin_found.id}" readonly>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">Full Name</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name="name" class="form-control" value="${admin_found.name}" required />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name="email" class="form-control" value="${admin_found.email}" required/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name="phone" class="form-control" value="${admin_found.phone}" required />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" name="address" class="form-control" value="${admin_found.address}" required />
                                            </div>
                                        </div>
                                        <div class="row">
