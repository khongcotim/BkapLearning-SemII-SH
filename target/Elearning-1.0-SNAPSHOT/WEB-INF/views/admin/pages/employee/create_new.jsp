                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="${rootAdmin}employee-manage"><i class="bx bx-home-alt"></i></a>
                                </li>
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="newEmployee" action="${rootAdmin}employee-manage/insert" enctype="multipart/form-data">
