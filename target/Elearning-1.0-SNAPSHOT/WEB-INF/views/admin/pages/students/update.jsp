...
<head>
    ...
    <title>Update Category | ${old_student.name}</title>
</head>
<body>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="${rootAdmin}student-manage"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Update</li>
                                <li class="breadcrumb-item active" aria-current="page">${old_student.name}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="old_student" action="${rootAdmin}students-manage/update" method="post">
