...
<head>
  ...
  <!-- Page Title -->
  <title>Elearning | Instructor Details</title>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="breadcrumb-link margin-top-10">
          <span><a href="${rootpath}">home</a> / instructor details page</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="instructor-image">
            <img src="<c:url value="/public/assets/images/instructor-details-image.jpg"/>" alt="instructor">
          </div>
        </div>
        <div class="col-lg-8">
          <div class="instructor-info">
            <h3>john doe</h3>
            <span class="instructor-tag">UI & UX teacher</span>
    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          <h2>courses by <span>john doe</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
