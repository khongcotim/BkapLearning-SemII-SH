...
<c:url value="/teacher/" var="rootTeacher"></c:url>
...
<svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Pages" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Login---V2" transform="translate(-667.000000, -290.000000)">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Teacher</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboards -->
        <li class="menu-item">
            <a href="${rootTeacher}" class="menu-link">
        ...
        <!-- Layouts -->
        <li class="menu-item">
            <a href="${rootTeacher}student-manage" class="menu-link">
        ...
        <li class="menu-item">
            <a href="${rootTeacher}course-manager" class="menu-link">
