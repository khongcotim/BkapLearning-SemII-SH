                ...
                <div class="col-lg-3 col-md-6">
                    <a href="course.html"><div class="single-category-item">
                        <div class="category-image">
                            <img src="<c:url value="/public/images/"/>${category.avatar}" width="84" height="84" alt="image">
    ...
    <div class="container">
        ...
        <div class="row grid">
                <c:forEach var="item" items="${courseByCate}">
                    <div class="col-lg-4 col-md-6 grid-item item${item.key}">
                        <c:forEach items="${item.value}" var="course">
                            <div class="single-course-item diffrent-bg-color">
                                <div class="course-image">
                                    <img src="<c:url value="/public/images/"/>${course.image}" width="330" height="224" alt="image">
                                </div>
                                <div class="course-content margin-top-30">
                                    ...
                                    <div class="course-instructor-rating margin-top-20">
                                        <div class="course-instructor">
                                            <img src="<c:url value="/public/images/teachers/"/>${course.teachers.avatar}" alt="instructor">
                                            <h6>${course.teachers.name}</h6>
                                        </div>
                                ...
                                <div class="hover-state">
                                    ...
                                    <div class="course-title margin-top-10">
                                        <h4><a href="/course.html/detail?id=${course.id}">${course.name}</a></h4>
                                    </div>
                                    <div class="course-price-info margin-top-20">
                                        <span class="best-seller">best seller</span>
                                        <span class="course-category"><a href="/course.html">${course.category.name}</a></span>
                                    </div>
                                    ...
                                    <div class="preview-button margin-top-20">
                                        <a href="/course.html/detail?id=${course.id}" class="template-button">course preview</a>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
