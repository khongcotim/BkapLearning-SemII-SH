                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="newCourse" action="${rootAdmin}course/insert">
                                            ...
                                            <hr/>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Enter Course's Name</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Title</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEnterYourPrice" class="col-sm-3 col-form-label">Enter Price</label>
                                                <div class="col-sm-9">
                                                    <f:input type="number" path="price" class="form-control" id="inputEnterYourPrice" placeholder="Enter Price..."></f:input>
                                                    <f:errors path="price" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Sale Price</label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="salePrice" class="form-control" id="inputEnterYourTitle" placeholder="Enter Sale Price..."></f:input>
                                                    <f:errors path="salePrice" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Choose Image</label>
                                                <div class="col-sm-9">
                                                    <f:input type="file" path="image" class="form-control" id="inputEnterYourTitle" placeholder="Enter Sale Price..."></f:input>
                                                    <f:errors path="image" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Fill the total times: </label>
                                                <div class="col-sm-9">
                                                    <f:input type="file" path="times" class="form-control" id="inputEnterYourTitle" placeholder="Enter total time of course, ex: 24hourse 24 minutes..."></f:input>
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Link video: </label>
                                                <div class="col-sm-9">
                                                    <f:input type="file" path="linkVideo" class="form-control" id="inputEnterYourTitle" placeholder="Enter link to embed video"></f:input>
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Description...: </label>
                                                <div class="col-sm-9">
                                                    <f:input type="file" path="description" class="form-control" id="inputEnterYourTitle" placeholder="Enter description..."></f:input>
