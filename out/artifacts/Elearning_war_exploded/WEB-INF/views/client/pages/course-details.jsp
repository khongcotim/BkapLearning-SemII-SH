...
<head>
  ...
  <!-- Page Title -->
  <title>Elearning | Course Detail </title>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="breadcrumb-link margin-top-10">
          <span><a href="${rootpath}">home</a> / course details page</span>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="course-details-widget">
            ...
            <div class="course-widget-items">
              <div class="single-item">
                <div class="item-left">
                  <span><i class="fa fa-usd"></i> price</span>
                </div>
              ...
              <div class="single-item">
                <div class="item-left">
                  <span><i class="fa fa-shopping-cart"></i> enrolled</span>
                </div>
                <div class="item-right">
              ...
              <div class="single-item">
                <div class="item-left">
                  <span><i class="fa fa-calendar"></i> deadline</span>
                </div>
                <div class="item-right">
          ...
          <div class="tab-content margin-top-30">
            <div class="tab-one-content tab-content-bg overview-content lost active">
              ...
              <div class="overview-video margin-top-30">
                <img src="<c:url value="/public/assets/images/blog-image-2.jpg"/>" alt="thumbnail">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="learn-item">
                    <li><i class="fa fa-check"></i> Assemble machine learning algorithms from scratch! Digital Marketing Trade<span></span></li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="learn-item">
                    <li><i class="fa fa-check"></i> <span> Unique Ways of Promoting a Business from Scratch Inbound Marketing</span></li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="learn-item">
            ...
            <div class="tab-three-content tab-content-bg instructor-content lost">
              ...
              <div class="instructor-skill-part margin-top-30">
