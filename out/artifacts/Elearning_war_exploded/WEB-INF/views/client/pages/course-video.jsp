    ...
    <div class="row">
      <div class="col-lg-8 p-0 order-2 order-lg-1">
        <div class="course-video-part">
          <video controls>
            <source src="<c:url value="/public/assets/video/html.mp4"/>" type="video/mp4"/>
          </video>
        </div>
        ...
        <div class="course-video-tab padding-top-60">
          ...
          <div class="tab-content">
            <div class="tab-one-content tab-content-bg overview-content lost active">
              ...
              <p class="margin-top-20">Advanced story telling techniques for writers: Personas, Characters & Plots  Proven Tips and Tricks of the Digital Marketing Trade growth Hacking. Unique Ways of Promoting a Business from Scratch</p>
              ...
              <div class="content-list-items margin-top-20">
                <div class="row">
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> Delectus harum deserunt ut optio corporis cum facilis aliquid tempore</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> Veniam maiores adipisci placeat ipsa dolorem culpa ipsam tenetur</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> Minima fugit nobis earum exercitationem a deleniti veniam maiores</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> Atque minima fugit nobis earum exercitationem ipsa obcaecati</span>
                  </div>
                </div>
              </div>
              <div class="video-tab-title margin-top-30">
              ...
              <div class="content-list-items margin-top-20">
                <div class="row">
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> skill level : beginner</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> lecture : 40</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> student : 50</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> video length : 02:00</span>
                  </div>
                  <div class="col-lg-6">
                    <span class="single-list"><i class="fa fa-check"></i> language : english</span>
                  </div>
                </div>
              </div>
              <div class="video-tab-title margin-top-30">
              ...
              <p class="margin-top-20">Get Course certificate by completing entire course</p>
              <div class="video-tab-title margin-top-30">
                <h5>description</h5>
              </div>
            ...
            <div class="tab-two-content tab-content-bg q-a-content lost">
              ...
              <div class="single-question">
                <div class="question-image">
                  <img src="<c:url value="/public/assets/images/question-image.png"/>" alt="image">
                </div>
            ...
            <div class="tab-four-content tab-content-bg announcement-content lost">
              <div class="announcement-top">
                <div class="top-image">
                  <img src="<c:url value="/public/assets/images/course-instructor-2.png"/>" alt="image">
                </div>
                <div class="top-name">
                  <h6>john doe</h6>
              ...
              <div class="announcement-comment margin-top-30">
                <div class="comment-image">
                  <img src="<c:url value="/public/assets/images/course-instructor-3.png"/>" alt="image">
                </div>
