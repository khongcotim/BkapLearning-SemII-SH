    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="breadcrumb-link margin-top-10">
          <span><a href="${rootpath}">home</a> / about page</span>
        </div>
      </div>
    </div>
  </div>
...
<section class="welcome-section padding-top-120">
  <div class="container">
    <div class="row">
      <div class="col-lg-3 align-self-end">
        <div class="welcome-image welcome-image-1">
          <img src="<c:url value="/public/assets/images/welcome-image-1.jpg"/>" alt="image">
        </div>
      </div>
      <div class="col-lg-4">
        <div class="welcome-image welcome-image-2">
          <img src="<c:url value="/public/assets/images/welcome-image-2.jpg"/>" alt="image">
        </div>
      </div>
      <div class="col-lg-5 col-md-12 align-self-center">
        <div class="welcome-text">
          <div class="section-title margin-bottom-30">
            <h2>wlcome to the <span>course LMS</span></h2>
          </div>
          <p>We’ll then ask you to tell us your current level of English or invite you to take our quick 20 minute placement. By connecting students all over the world to the best instructors.</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-5 col-md-6">
        <div class="welcome-image welcome-image-3">
          <img src="<c:url value="/public/assets/images/welcome-image-3.jpg"/>" alt="image">
        </div>
      </div>
      <div class="col-lg-5 col-md-6">
        <div class="welcome-image welcome-image-4">
          <img src="<c:url value="/public/assets/images/welcome-image-4.jpg"/>" alt="image">
        </div>
      </div>
    </div>
  </div>
...
<section class="welcome-content">
  <div class="container">
    <div class="row">
      <div class="col-xl-9">
        <div class="section-title margin-bottom-30">
          <h2>the leading global marketplace for <span>learning and instruction</span></h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        ...
        <p class="margin-top-30">how the hammocks empower artisan weavers and their families. The company breaks down different pieces of the story into sections that combine words and easily digestible graphics, painting a picture instead of big chunks of text. They're clear about why they're different: "Not a Charity," the page reads.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="counterup-section about-page">
  <div class="container">
...
<section class="category-section about-page gradient-bg">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          <div class="category-image">
            <img src="<c:url value="/public/assets/images/category-icon-2.png"/>" alt="image">
            <img src="<c:url value="/public/assets/images/round-shape-3.png"/>" alt="shape" class="feature-round-shape-3">
          </div>
          <div class="category-title margin-bottom-10">
            <h4>marketing</h4>
      ...
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          <div class="category-image">
            <img src="<c:url value="/public/assets/images/category-icon-4.png"/>" alt="image">
            <img src="<c:url value="/public/assets/images/round-shape-3.png"/>" alt="shape" class="feature-round-shape-3">
          </div>
          <div class="category-title margin-bottom-10">
            <h4>business</h4>
      ...
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          <div class="category-image">
            <img src="<c:url value="/public/assets/images/category-icon-5.png"/>" alt="image">
            <img src="<c:url value="/public/assets/images/round-shape-3.png"/>" alt="shape" class="feature-round-shape-3">
          </div>
          <div class="category-title margin-bottom-10">
            <h4>psychology</h4>
      ...
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          ...
          <span>05 course(S)</span>
        </div></a>
      </div>
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          <div class="category-image">
            <img src="<c:url value="/public/assets/images/category-icon-7.png"/>" alt="image">
            <img src="<c:url value="/public/assets/images/round-shape-3.png"/>" alt="shape" class="feature-round-shape-3">
          </div>
          <div class="category-title margin-bottom-10">
            <h4>technology</h4>
          </div>
          <span>09 course(S)</span>
        </div></a>
      </div>
      <div class="col-lg-3 col-md-6">
        <a href="#"><div class="single-category-item">
          <div class="category-image">
            <img src="<c:url value="/public/assets/images/category-icon-8.png"/>" alt="image">
            <img src="<c:url value="/public/assets/images/round-shape-3.png"/>" alt="shape" class="feature-round-shape-3">
          </div>
          <div class="category-title margin-bottom-10">
            <h4>photography</h4>
          </div>
          <span>08 course(S)</span>
        </div></a>
      </div>
    </div>
  </div>
...
<section class="analysis-section">
  <div class="container">
    <div class="analysis-bg-color">
      <div class="row">
        <div class="col-lg-6">
          <div class="analysis-content">
            <div class="course-title margin-top-10">
              <h3>the complete financial analysis course</h3>
            </div>
...
<section class="instructor-section about-page">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center">
