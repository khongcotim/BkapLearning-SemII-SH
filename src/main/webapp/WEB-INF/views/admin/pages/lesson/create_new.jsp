                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="newLesson" action="${rootAdmin}lesson/insert" enctype="multipart/form-data">
                                            ...
                                            <hr/>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Lesson's name</label>
                                                <div class="col-sm-9">
