                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                                <a class="dropdown-item" href="${rootAdmin}employee-manage/init-insert">Add new</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-9 col-xl-10">
                                        <form class="float-lg-end" method="post" action="${rootAdmin}employee-manage/search">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <c:forEach items="${employee}" var="item" varStatus="loop">
                                            <tr>
                                                <th scope="row">${loop.index+1}</th>
                                                <td><a href="${rootAdmin}/employee-manage/detail?id=${item.id}">${item.name}</a></td>
                                                <td><img src="<c:url value="/public/images/employee/"/>${item.avatar}" width="80" height="120" alt=""></td>
                                                <td>${item.email}</td>
                                                <td>${item.gender==true?"Nam":"Nữ"}</td>
                                                <td>${item.address}</td>
                                                <td>
                                                    <a href="${rootAdmin}employee-manage/init-update?id=${item.id}"><i class="bx bxs-edit"></i></a>
                                                    <a href="${rootAdmin}employee-manage/delete?id=${item.id}"><i class="bx bx-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                            ...
                            <nav aria-label="Page navigation example" class="align-self-center">
                                <ul class="pagination round-pagination">
                                    <li class="page-item" >
                                        <a class="page-link" href="${rootAdmin}employee-manage/page/${page-1}">Previous</a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="page">
                                        <li class="page-item"><a class="page-link" href="${rootAdmin}employee-manage/page/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item"><a class="page-link" href="${rootAdmin}employee-manage/page/${page+1}">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
