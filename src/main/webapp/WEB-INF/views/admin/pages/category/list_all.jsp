                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-9 col-xl-10">
                                        <form class="float-lg-end" method="post" action="${rootAdmin}category/search">
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                        <c:forEach items="${category}" var="item" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>${item.name}</td>
                                                <td>
                                                    <img src="<c:url value="/public/images/"/>${item.avatar}" width="100" height="120">
                                                </td>
                                                <td>${item.status==true?"Active":"In active"}</td>
                                                <td>
                                                    <a href="${rootAdmin}category/init-update?id=${item.id}"><i class="bx bxs-edit"></i></a>
                                                    <a href="${rootAdmin}category/delete?id=${item.id}"><i class="bx bx-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                            ...
                            <nav aria-label="Page navigation example" class="align-self-center">
                                <ul class="pagination round-pagination">
                                    <li class="page-item" >
                                        <a class="page-link" href="${rootAdmin}category/page/${page-1}">Previous</a>
                                    </li>
                                    <c:forEach begin="1" end="${pages}" var="page">
                                        <li class="page-item"><a class="page-link" href="${rootAdmin}category/page/${page}">${page}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item"><a class="page-link" href="${rootAdmin}category/page/${page+1}">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
