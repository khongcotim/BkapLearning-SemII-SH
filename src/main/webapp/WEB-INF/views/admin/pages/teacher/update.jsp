...
<head>
    ...
    <title>Update Teacher | ${old_teacher.name}</title>
</head>
<body>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="${rootAdmin}teacher-manage"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Update</li>
                                <li class="breadcrumb-item active" aria-current="page">${old_teacher.name}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="old_teacher" action="${rootAdmin}teacher-manage/update" method="post" enctype="multipart/form-data">
                                            <f:input path="id" type="hidden"></f:input>
                                            <div class="card-title d-flex align-items-center">
                                                <div><i class="bx bxs-user me-1 font-22 text-info"></i>
                                                </div>
                                                <h5 class="mb-0 text-info">Add new Teacher</h5>
                                            </div>
                                            <hr/>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourName" class="col-sm-3 col-form-label">Enter Teacher's Name</label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="name" class="form-control" id="inputEnterYourName" placeholder="Enter Teacher's Name" required="required"></f:input>
                                                    <f:errors path="name" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-upload-file">Avatar</label>
                                                <div class="input-group input-group-merge">
                                                    <input type="file" class="form-control" id="basic-default-upload-file" name="avatarName" required />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Email</label>
                                                <div class="col-sm-9">
                                                    <f:input type="email" path="email" class="form-control" id="inputEnterYourTitle" placeholder="Enter Email..." required="required"></f:input>
                                                    <f:errors path="email" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourPrice" class="col-sm-3 col-form-label">Enter Phone</label>
                                                <div class="col-sm-9">
                                                    <f:input type="number" path="phone" class="form-control" id="inputEnterYourPrice" placeholder="Enter Phone..." required="required"></f:input>
                                                    <f:errors path="phone" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>
                                            <label>Gender</label>
                                            <div class="form-check">
                                                <f:radiobutton path="gender" checked="checked" class="form-check-input" id="validationFormCheck2" name="radio-stacked" value="true" required="required" />
                                                <label class="form-check-label" for="validationFormCheck2">Nam</label>
                                                <f:errors path="gender" cssStyle="color:red;"></f:errors>
                                            </div>
                                            <div class="form-check">
                                                <f:radiobutton path="gender" class="form-check-input" id="validationFormCheck1" name="radio-stacked" value="false" required="required" />
                                                <label class="form-check-label" for="validationFormCheck1">Nữ</label>
                                                <f:errors path="gender" cssStyle="color:red;"></f:errors>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Address...: </label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="address" class="form-control" id="inputEnterYourTitle" placeholder="Enter Address..." required="required"></f:input>
