...
<head>
    ...
    <title>Add new Teacher Account</title>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Teacher Account Manage</div>
                    <div class="ps-3">
                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <f:form modelAttribute="newTeacherAcc" action="${rootAdmin}teacher-manage/insert" enctype="multipart/form-data">
                                            <div class="card-title d-flex align-items-center">
                                                <div><i class="bx bxs-user me-1 font-22 text-info"></i>
                                                </div>
                                                <h5 class="mb-0 text-info">Add new Account</h5>
                                            </div>
                                            <hr/>
                                            <div class="row mb-3">
                                                <div class="col-6">
                                                    Account For:
                                                    <f:select  class="form-select mb-3" aria-label="Default select example" path="id">
                                                        <c:forEach items="${noneAcc}" var="item">
                                                            <option value="${item.id}">${item.name}</option>
                                                        </c:forEach>
                                                    </f:select>
                                                <f:errors path="id" cssStyle="color: red"></f:errors></div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputEnterYourUserName" class="col-sm-3 col-form-label">User Name</label>
                                                <div class="col-sm-9">
                                                    <f:input type="text" path="userName" class="form-control" id="inputEnterYourUserName" placeholder="Enter User Name..." required="required"></f:input>
                                                    <f:errors path="userName" cssStyle="color:red;"></f:errors>
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="inputEnterYourTitle" class="col-sm-3 col-form-label">Enter Password </label>
                                                <div class="col-sm-9">
